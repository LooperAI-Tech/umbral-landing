...
import { page } from "@/lib/content-techproducts";
    ...
    <div className="min-h-screen bg-zinc-50">
      ...
      <div className="fixed top-0 left-0 right-0 z-50 bg-zinc-900 text-white text-center py-2 px-4">
        <p className="text-xs font-medium">
          {page.announcement} <a href={page.registerUrl} target="_blank" rel="noopener noreferrer" className="underline hover:text-zinc-300 transition-colors">{page.announcementLink}</a>
        </p>
      </div>
      ...
      <nav className="fixed top-8 left-0 right-0 z-50 px-6 py-4 flex justify-center pointer-events-none">
        ...
        >
          ...
          >
            <span className="italic">{global.communityName} </span>
